...
<?= Html::a('Back', ['/writerbooster/project/index'], ['class' => 'btn btn-info']) ?> 
<a id="btn-start" href="JavaScript:newPopup('<?=Url::to(['/writerbooster/project/counter', 'id' => $model->id])?>');" class="btn btn-warning" >START POMODORO TIMER</a>
...
<h3>Total Writing Duration for the project: <span id="pomo_duration"><?=$model->pomo_duration?></span></h3>
 ...
 <?=$form->field($model, 'pomodoro')->hiddenInput()->label(false)?>
  ...
  <div class="form-group">
        <?= Html::submitButton('<i class="fa fa-save"></i> Save Writing', ['class' => 'btn btn-success']) ?>
    </div>
