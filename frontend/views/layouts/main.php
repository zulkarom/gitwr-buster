					...
					<div class="row">
						<div class="col">
							<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
								<div class="top_bar_phone"><span class="top_bar_title">WRITER BOOSTER 1.0</div>
			...
			<div class="container">
				<div class="row">
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							...
							<div class="logo_text" style="color:#000000"></div>
				...
				function menu($mm = false){
					...
					if(Yii::$app->user->isGuest){
						...
						$arr = [
							'HOME' => Url::to(['/site/index']),
							'<i class="fa fa-list"></i> MY PROJECT' => Url::to(['/project/index/']),
							'<i class="fa fa-plus"></i> ADD PROJECT' => Url::to(['/project/create/']),
							'PROJECT REPORT' => Url::to(['/page/submission-guideline']),
